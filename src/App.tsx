      ...
      {activeView !== 'admin' && (
        <div className="fixed bottom-4 right-3 sm:bottom-5 sm:right-5 z-30 flex flex-col items-end gap-2">
          ...
          <a
            ...
            className="group flex items-center gap-1.5 p-2 sm:px-3.5 sm:py-2.5 rounded-full bg-[#25D366] hover:bg-[#20ba59] text-white shadow-lg transition-all hover:scale-105 cursor-pointer text-xs font-bold"
          ...
          >
            ...
            <span className="hidden sm:inline font-bold text-white tracking-wide text-xs">WhatsApp</span>
          </a>
        </div>
      )}
    </div>
