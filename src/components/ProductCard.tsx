      ...
      <div className="p-2.5 sm:p-4 flex-1 flex flex-col justify-between">
        <div>
          ...
          <div className="flex items-center justify-between gap-1 text-[10px] sm:text-[11px] text-stone-500 mb-1">
            <span className="font-medium text-rose-800/80 uppercase tracking-wider text-[9px] sm:text-[10px] truncate">
              {product.subcategory || product.categoryId}
            </span>
            <span className="font-mono text-[9px] sm:text-[10px] font-bold text-stone-500 bg-stone-100 px-1.5 py-0.5 rounded border border-stone-200/60 shrink-0">
