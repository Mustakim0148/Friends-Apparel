...
export const HomePage: React.FC = () => {
  ...
  // Show all products on the home page so every newly added product is visible immediately
  ...
  return (
    <div className="space-y-6 sm:space-y-10 pb-8 sm:pb-12">
      ...
      <section className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-3 sm:mb-6">
          <div>
            ...
            <p className="text-[11px] sm:text-xs text-stone-500">
              Explore our complete clothing collection available nationwide
            </p>
          </div>
          <button
            onClick={() => {
      ...
      {/* Latest Collection Section (only shown if specific new arrivals exist) */}
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-4 sm:mb-6">
            <div>
              ...
              <p className="text-[11px] sm:text-xs text-stone-500">
                Freshly added styles to our collection
              </p>
            </div>
            <button
              onClick={() => {
