    ...
    <div className="space-y-6 sm:space-y-10 pb-8 sm:pb-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-4">
          {categories.map(cat => (
            ...
            >
              ...
              <span className="text-[9px] sm:text-[10px] text-stone-400 font-medium mt-0.5">
      ...
      <section className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-3 sm:mb-6">
          <div>
            <div className="flex items-center gap-1.5 text-[11px] sm:text-xs font-bold text-rose-800 uppercase tracking-wider mb-0.5 sm:mb-1">
              <Sparkles className="w-3.5 h-3.5" />
              <span>Handpicked For You</span>
            </div>
            <h2 className="font-serif text-xl sm:text-3xl font-bold text-stone-900">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-xs text-stone-500">
              The latest silhouettes in comfortable cottons, florals, and modest wear
            </p>
          </div>
          <button
            onClick={() => {
