  ...
  if (!product) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-16 text-center">
        <p className="text-stone-600 mb-4">No product selected</p>
        <button
          onClick={() => setActiveView('catalog')}
          className="px-6 py-2.5 rounded-full bg-rose-800 text-white font-semibold text-sm hover:bg-rose-900 transition-colors cursor-pointer"
        >
          View All Products
        </button>
      </div>
